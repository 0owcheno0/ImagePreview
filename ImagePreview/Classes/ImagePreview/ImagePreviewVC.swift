...
class ImagePreviewVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
//        self.navigationItem.titleView = CommonLogic.setDisplayCustomTitleText("图片预览", withTextColor: UIColor.white)
...
extension ImagePreviewVC:UICollectionViewDelegate, UICollectionViewDataSource,
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        -> UICollectionViewCell {
            ...
            if self.isFromNetWork {
//                cell.imageView.kf.setImage(with: URL(string: self.images[indexPath.row] as! String), placeholder: UIImage(named: "defaultImageIcon"))
            } else {
